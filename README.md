...
Разработаем решение для сканирования защищаемого периметра, анализа сервисов и оповещения об обнаруженных открытых портах. 
Инструмент будет построен на `Python` с интеграцией `Masscan` 
